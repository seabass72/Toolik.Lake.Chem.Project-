...
The arctic region of Alaska is a diverse and an ecologically important landscape. There has been a substantial amount of research done at the lakes located near the Toolik Field station in the past. However, there has not been much research looking at the the lakes in the recent past (2010-2019). My interest is to look at how these systems are reacting to current climate conditions. I want to understand if the lakes are different and what factors would be helpful to predict chlorophyll a concentrations. Additionally, I want to understand if there are trends that have occurred during the study period (2010-2014). Understanding the factors that are important in predicting chlorophyll a concentrations in these lakes could help understand the chlorophyll dynamics in lakes that are located in the arctic belt around the world. Finally, understanding the trends between 2010-2014 could help us understand if climate change is impacting and altering the dynamics of these systems. 
